---
name: my-postmortem
description: 写事故 postmortem — 当用户说"复盘" / "postmortem" / "事故" / production incident 后使用。包含 timeline + 5-Whys + action items + 必含 8 段结构（模板参 docs/postmortems/README.md，如有）。
---
...
> **关联**: [`docs/postmortems/README.md §模板`](../../../docs/postmortems/README.md)（按需创建）+ 项目内既有 postmortems 范例
...
例：`docs/postmortems/2026-MM-DD_<root-cause-slug>.md`
...
- ❌ 不省略 5-Whys（根因猜测会导致 fix 后 symptom 仍在，典型双重纠正教训）
