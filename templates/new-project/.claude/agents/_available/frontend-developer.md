...
export const DataTable = memo<DataTableProps>(({ data, columns, onRowClick }) => {
  ...
  return (
    <div ref={parentRef} className="h-96 overflow-auto" role="table">
...
1. **Project Setup** — configure tooling, build optimization, testing framework
2. **Component Development** — reusable components with TypeScript, mobile-first responsive design
3. **Performance Optimization** — code splitting, image optimization, Core Web Vitals
4. **Testing & QA** — unit tests, accessibility testing, cross-browser compatibility
...
- PWA with offline functionality and service workers
