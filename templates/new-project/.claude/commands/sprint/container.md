...
开新滚动容器(如 `feature/dev.260520`)显式入口。**调用 `my-start-container` skill**(`disable-model-invocation: true`,只能显式 invoke 防误开)。
...
|---|---|
| C1 日历日已换 | 今日 > 当前容器名日期 |
| C2 当前容器已 merge + push | `git log origin/feature/dev` 含 merge |
...
- 事故案例: `docs/postmortems/2026-05-18_worktree-collision-and-pm-merge-slip.md`
